...
/**
 * Support class (of {@link ExtendedRDFSProperty}) for generating resource class removeAll-methods
 * for this property.
 */
@Partial
public abstract class RemoverAllSupport extends PropertyBuildingSupport implements ExtendedRDFSProperty {
    ...
    MethodSpec buildSignature(OntGenerationConfig config) {
        if(getRanges() != null) {
            ...
            try {
                ...
                methodName = "removeAll" + nameBuilder.capitalizedPluralIdentifier();
    ...
    @Override
    public MethodSpec buildRemoverAll(OntGenerationConfig config) {
