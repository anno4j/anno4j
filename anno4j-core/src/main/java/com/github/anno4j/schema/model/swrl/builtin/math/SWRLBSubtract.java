 ...
 * <a href="http://www.w3.org/2003/11/swrlb#subtract">http://www.w3.org/2003/11/swrlb#subtract</a> .
 ...
 */
@SWRLBuiltinIri(SWRLB.SUBTRACT)
public class SWRLBSubtract extends SWRLBuiltin implements Computation {
     ...
     */
    public SWRLBSubtract(List<Object> arguments) {
        super(arguments);
        // Check that there are three arguments:
        if(arguments.size() != 3) {
            throw new IllegalArgumentException("swrlb:subtract expects three arguments. " + arguments.size() + " passed.");
        }
        // Check all non-variable arguments are numeric:
        for(Object argument : arguments) {
            if(!(argument instanceof Variable || argument instanceof Number)) {
                throw new IllegalArgumentException("swrlb:subtract expects non-variable arguments to be numeric.");
            }
        }
    }
