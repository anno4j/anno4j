...
public interface Computation {
     ...
     * @throws UndeterminedSolutionException Thrown if more than one variable is not bound by {@code bindings}.
     ...
     */
    SolutionSet solve(Bindings bindings) throws InfiniteResultException, IllegalArgumentException, UndeterminedSolutionException;
}
